...
if __name__ == "__main__":
    ...
    model_name = "/project/lt900054-ai2416/400256-PP/ILOVELANTA/SuperAI_LLM_FineTune/checkpoint/checkpoint8_refine"
    ...
    llm = HuggingFaceLLM(
        ...
        generate_kwargs={"temperature": 0.1, 'num_beams': 10,},
    )
